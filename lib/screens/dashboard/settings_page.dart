...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void initState() {
    ...
    _dailyLimitC =
        TextEditingController(text: '${_draft.dailyMessageLimit}');
    _maxLengthC =
        TextEditingController(text: '${_draft.maxMessageLength}');
  }
      ...
      child: Column(
        ...
        children: [
          ...
          _SectionCard(
            ...
            children: [
              const Text('اختر النماذج المفعّلة للطلاب:',
                  style: TextStyle(
              ...
              Wrap(
                spacing: 12,
                runSpacing: 12,
                children: ['deepseek', 'gemini', 'claude', 'gpt']
                    .map((model) {
                  final isEnabled =
                      _draft.aiModelsEnabled[model] ?? false;
                      ...
                      setState(() {
                        final updated =
                            Map<String, bool>.from(
                                _draft.aiModelsEnabled);
                        updated[model] = !isEnabled;
                        _draft = _draft.copyWith(
                            aiModelsEnabled: updated);
                      });
                    },
              ...
              Row(children: [
                ...
                DropdownButton<String>(
                  ...
                  items: ['deepseek', 'gemini', 'claude', 'gpt']
                      .where(
                          (m) => _draft.aiModelsEnabled[m] == true)
                  ...
                  onChanged: (v) {
                    if (v != null) {
                      setState(() => _draft =
                          _draft.copyWith(defaultModel: v));
                    }
                  },
                ),
              ]),
          ...
          _SectionCard(
            ...
            children: [
              ...
              SwitchListTile(
                ...
                subtitle: const Text(
                    'السماح للطلاب بإرسال ملفات وصور في الشات',
                    style: TextStyle(fontSize: 12)),
                value: _draft.attachmentsEnabled,
                onChanged: (v) => setState(() =>
                    _draft = _draft.copyWith(
                        attachmentsEnabled: v)),
              ),
            ],
          ),
          const SizedBox(height: 24),
              ...
              if (_draft.maintenanceMode)
                Container(
                  ...
                  child: const Row(children: [
                    ...
                    SizedBox(width: 8),
                    Text('⚠️ وضع الصيانة مُفعّل حالياً',
                        style: TextStyle(
                            color: AppColors.warning,
