...
class _CoursesPageState extends State<CoursesPage> {
              ...
              try {
                ...
                if (result != null && result.files.isNotEmpty) {
                  ...
                  if (file.bytes != null) {
                    ...
                    setDialogState(() {
                      coverC.text = 'data:image/$ext;base64,$base64Image';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: Text(
                          t('Upload Cover Image', 'تحميل صورة الغلاف'),
                        ),
    ...
    showDialog(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          title: Text(
            t('Create New Chapter', 'إنشاء فصل جديد'),
            style: const TextStyle(color: Colors.white),
          ),
          content: TextField(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final success = await provider.createChapter(
                  courseId,
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              title: Text(
                t('Add Lesson to Chapter', 'إضافة درس للفصل'),
                style: const TextStyle(color: Colors.white),
              ),
              content: Column(
                mainAxisSize: MainAxisSize.min,
  ...
  Future<void> _pickAndUploadFile(
    ...
    //   type: fileType == 'video' ? FileType.video : FileType.custom,
    //   allowedExtensions: fileType == 'video' ? null : ['pdf'],
    //   withData: false, // For large files, avoid loading into memory if not needed
    // );
    final result = null;
    ...
    if (result != null && result.files.isNotEmpty) {
      ...
      if (file.path != null) {
        ...
        // on web if withData is false, we might only get readStream
        if (file.readStream != null) {
          // not supported perfectly without bytes on web in cross_file but this works for most
          return;
        }
        return;
      }
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: t(
                        ...
                        'بحث الكورسات بالاسم أو التصنيف...',
                      ),
  ...
  Widget _buildCourseGrid(
    ...
    if (list.isEmpty) {
      return Center(
        child: Text(
          t(
            'No courses found. Add a course to start building the curriculum.',
            'لم يتم العثور على كورسات. أضف كورس للبدء في بناء المنهج الدراسي.',
          ),
                              ...
                              Row(
                                children: [
                                  IconButton(
                                    ...
                                    color: accentColor,
                                    tooltip: t(
                                      'Manage Content / Curriculum',
                                      'إدارة المحتوى / المنهج',
                                    ),
                                    onPressed: () {
  ...
  Widget _buildThreeColumnEditor(
    CoursesProvider provider,
    Color cardColor,
    Color accentColor,
    String Function(String, String) t,
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Text(
                t(
                  'CMS Console: ${provider.selectedCourse!.title}',
                  'لوحة التحكم: ${provider.selectedCourse!.title}',
                ),
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 16,
          ...
          child: isWideScreen
              ? Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 320,
                      child: _buildColumn1(provider, cardColor, accentColor, t),
                    ),
                    const VerticalDivider(width: 1),
                    // Column 2: Curriculum Outline
                    Expanded(
                      flex: 4,
                      child: _buildColumn2(provider, cardColor, accentColor, t),
                    ),
                    const VerticalDivider(width: 1),
                    // Column 3: Lesson detail configuration
                    Expanded(
                      flex: 5,
                      child: _buildColumn3(provider, cardColor, accentColor, t),
                    ),
                  ],
                )
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (v) => v == null || v.isEmpty
                  ? t('Title is required', 'العنوان مطلوب')
                  : null,
            ),
            const SizedBox(height: 16),
            TextFormField(
              ...
              validator: (v) => v == null || v.isEmpty
                  ? t('Description is required', 'الوصف مطلوب')
                  : null,
            ),
            const SizedBox(height: 16),
            TextFormField(
            ...
            child: provider.chapters.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isChapterEditing =
                          _editingChapter?.id == chapter.id;
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  if (!isChapterEditing) ...[
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () => provider.deleteChapter(
                                        course.id,
                                        chapter.id,
                                      ),
                                      padding: EdgeInsets.zero,
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () async {
                                        if (_chapterTitleController.text
                                            .trim()
                                            .isNotEmpty) {
                                          await provider.updateChapter(
                                            course.id,
                            ...
                            if (lessons.isEmpty)
                              Padding(
                                ...
                                child: Text(
                                  t(
                                    'Empty chapter. Add lessons above.',
                                    'فصل فارغ. أضف دروساً من الأعلى.',
                                  ),
                                  style: const TextStyle(
                                    color: Colors.white24,
                                    fontSize: 11,
                              ...
                              ListView.builder(
                                ...
                                itemBuilder: (context, lesIndex) {
                                  ...
                                  final isSelected =
                                      provider.selectedLesson?.id == les.id;
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                t(
                  'Select a lesson in the curriculum outline to edit its parameters and upload contents.',
                  'اختر درساً من منهج الكورس لتعديل خصائصه ورفع المحتوى الخاص به.',
                ),
        ...
        child: ListView(
          children: [
            ...
            TextFormField(
              ...
              validator: (v) => v == null || v.isEmpty
                  ? t('Lesson title is required', 'عنوان الدرس مطلوب')
                  : null,
            ),
            const SizedBox(height: 16),
            TextFormField(
                      ...
                      if (uploadStatus != 'idle')
                        Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              color: _getStatusColor(uploadStatus),
                              fontSize: 9,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                  ...
                  if (uploadStatus == 'uploading' ||
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          t(
                            '${(uploadProgress * 100).toStringAsFixed(1)}% Completed',
                            'مكتمل بنسبة ${(uploadProgress * 100).toStringAsFixed(1)}%',
                          ),
                          style: const TextStyle(
                            color: Colors.white54,
                            fontSize: 11,
                        ...
                        Text(
                          t(
                            'Speed: ${uploadSpeed.toStringAsFixed(2)} MB/s',
                            'السرعة: ${uploadSpeed.toStringAsFixed(2)} ميغابايت/ث',
                          ),
                    ...
                    ElevatedButton.icon(
                      onPressed: () =>
                          _pickAndUploadFile(provider, lesson.type, lesson.id),
                      icon: const Icon(Icons.cloud_upload_rounded),
                      label: Text(
                        t('Replace Uploaded File', 'استبدال الملف المرفوع'),
                      ),
                      style: ElevatedButton.styleFrom(
                    ...
                    Text(
                      t(
                        'No file uploaded for this resource yet. Select a file from your system to initiate a chunked upload session.',
                        'لا يوجد ملف مرفوع لهذا الدرس بعد. اختر ملفاً من جهازك لبدء جلسة الرفع مقطّعة.',
                      ),
                      style: const TextStyle(
                        color: Colors.white30,
                        fontSize: 11,
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text(
                        lesson.type == 'video'
                            ? t('Select & Upload Video', 'اختر وارفع الفيديو')
                            : t('Select & Upload PDF', 'اختر وارفع ملف PDF'),
                      ),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: accentColor,
                        foregroundColor: const Color(0xFF0F172A),
                ...
                if (_lessonFormKey.currentState!.validate()) {
                  ...
                  if (success && mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          t('Lesson details saved!', 'تم حفظ تفاصيل الدرس!'),
                        ),
                        backgroundColor: const Color(0xFF10B981),
                        behavior: SnackBarBehavior.floating,
                      ),
  ...
  Widget _buildCourseCoverUploader(
    Color accentColor,
    String Function(String, String) t,
  ) {
    Future<void> pickColumn1Cover() async {
      try {
        // final result = await FilePicker.pickFiles(type: FileType.image, withData: true);
        final result = null;
        if (result != null && result.files.isNotEmpty) {
          ...
          if (file.bytes != null) {
            ...
            final ext = file.extension ?? 'png';
            setState(() {
              _courseCoverUrlController.text =
