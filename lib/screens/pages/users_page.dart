...
class _UsersPageState extends State<UsersPage> {
  ...
  final List<UserModel> _mockUsersList = [
    UserModel(
      uid: 'u1',
      name: 'Dr. Sarah Jenkins',
      email: 'sarah.j@stustep.edu',
      role: 'teacher',
      status: 'active',
    ...
    UserModel(
      uid: 'u2',
      name: 'Eng. Ahmad Qasim',
      email: 'ahmad.q@stustep.edu',
      role: 'teacher',
      status: 'active',
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              title: Text(
                t('Modify Role: ${user.name}', 'تعديل صلاحية: ${user.name}'),
              ...
              content: Column(
                ...
                children: [
                  Text(
                    t('Select new role:', 'اختر الصلاحية الجديدة:'),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (authProvider.useMock) {
                      setState(() {
                        final idx = _mockUsersList.indexWhere(
                          (u) => u.uid == user.uid,
                        );
                        if (idx != -1) {
                          _mockUsersList[idx] = _mockUsersList[idx].copyWith(
                            role: tempRole,
                          );
                        }
                      });
        ...
        return AlertDialog(
          ...
          title: Text(
            nextStatus == 'suspended'
                ...
                : t('Unsuspend Account?', 'تنشيط الحساب؟'),
            style: const TextStyle(color: Colors.white),
          ),
          content: Text(
            t(
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Text(
            t('Delete User Account?', 'حذف حساب المستخدم؟'),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pop(context);
                _showSuccessSnackBar(
                  t('User record deleted.', 'تم حذف سجل المستخدم.'),
                );
              },
              style: ElevatedButton.styleFrom(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      items: ['All', 'Admin', 'Teacher', 'Student'].map((role) {
                        String label = role;
                        if (role == 'All')
                          label = t('All Roles', 'جميع الصلاحيات');
      ...
      return Center(
        child: Text(
          t(
            ...
            'لم يتم العثور على مستخدمين يطابقون الفلاتر.',
          ),
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                tooltip: user.status == 'active'
                                    ...
                                    : t('Activate', 'تنشيط'),
                                onPressed: () =>
                                    _showToggleStatusDialog(user, t),
                              ),
                              IconButton(
                                icon: const Icon(
