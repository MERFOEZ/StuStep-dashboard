      ...
      child: Column(
        ...
        children: [
          ...
          _SectionCard(
            ...
            children: [
              const Text('اختر النماذج المفعّلة للطلاب:', style: TextStyle(color: AppColors.textSecondary, fontSize: 13)),
                  ...
                  return InkWell(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: isEnabled ? color.withValues(alpha: 0.15) : AppColors.surfaceLight,
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
              ...
              Row(
                children: [
                  const Text('النموذج الافتراضي:', style: TextStyle(color: AppColors.textSecondary, fontSize: 13)),
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: TextFormField(
                      controller: _dailyLimitC,
                      decoration: const InputDecoration(labelText: 'حد الرسائل اليومي'),
                  ...
                  Expanded(
                    child: TextFormField(
                      controller: _maxLengthC,
                      decoration: const InputDecoration(labelText: 'الحد الأقصى لطول الرسالة'),
                      keyboardType: TextInputType.number,
                    ),
                  ),
                ],
          ...
          _SectionCard(
            ...
            children: [
              SwitchListTile(
                ...
                subtitle: const Text(
                  'عند التفعيل، سيظهر للطلاب إشعار بأن التطبيق تحت الصيانة',
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text('⚠️ وضع الصيانة مُفعّل حالياً', style: TextStyle(color: AppColors.warning, fontWeight: FontWeight.w600)),
                    ],
                  ),
                ),
            ],
